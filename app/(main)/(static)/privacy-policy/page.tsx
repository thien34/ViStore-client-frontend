        ...
        <section className='flex flex-col gap-2 px-2 py-4'>
            ...
            <section>
                ...
                <p className='p-2'>
                    ...
                    provide customer support, and improve our products and services.
                </p>
                <p className='p-2'>
                    We do not use your personal information for promotional email campaigns or direct marketing
                    purposes.
                </p>
            </section>
